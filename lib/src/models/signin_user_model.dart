...
String getSignInUserModelToJson(GetSignInUserModel data) =>
    json.encode(data.toJson());

class GetSignInUserModel {
  GetSignInUserModel({
    SignInUserDataModel? data,
    bool? success,
    String? message,
    dynamic errors,
  }) {
  ...
  GetSignInUserModel.fromJson(dynamic json) {
    _data = json['data'] != null
        ? SignInUserDataModel.fromJson(json['data'])
        : null;
    _success = json['success'];
    _message = json['message'];
    _errors = json['errors'];
  }
  SignInUserDataModel? _data;
  bool? _success;
  String? _message;
  dynamic _errors;
  GetSignInUserModel copyWith({
    SignInUserDataModel? data,
    bool? success,
    String? message,
    dynamic errors,
  ...
  SignInUserDataModel? get data => _data;
...
SignInUserDataModel dataFromJson(String str) =>
    SignInUserDataModel.fromJson(json.decode(str));
String dataToJson(SignInUserDataModel data) => json.encode(data.toJson());

class SignInUserDataModel {
  SignInUserDataModel({
    User? user,
    String? token,
  }) {
  ...
  SignInUserDataModel.fromJson(dynamic json) {
    _user = json['user'] != null ? User.fromJson(json['user']) : null;
    _token = json['token'];
  }
  User? _user;
  String? _token;
  SignInUserDataModel copyWith({
    User? user,
    String? token,
  }) =>
      SignInUserDataModel(
